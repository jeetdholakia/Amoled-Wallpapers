...
import com.uxgarage.wallpaperlibrary.fragments.dialogs.WallpaperSettingsFragment;
...
import com.uxgarage.wallpaperlibrary.helpers.ViewHelper;
        ...
        if (id == android.R.id.home) {
            ...
            if (PermissionHelper.isStorageGranted(this)) {
                File target = new File(WallpaperHelper.getDefaultWallpapersDirectory(this).toString()
                        + File.separator + mName + "_" + System.currentTimeMillis() + WallpaperHelper.IMAGE_EXTENSION);
