package com.uxgarage.wallpaperlibrary.helpers;
...
public class LicenseCallbackHelper implements LicenseCallback {
    ...
    public LicenseCallbackHelper(@NonNull Context context) {
        ...
        builder.typeface(com.uxgarage.wallpaperlibrary.helpers.TypefaceHelper.getMedium(mContext), com.uxgarage.wallpaperlibrary.helpers.TypefaceHelper.getRegular(mContext));
