    ...
    private void checkRszIo() {
        mCheckRszIo = new AsyncTask<Void, Void, Boolean>() {
            ...
            protected void onPostExecute(Boolean aBoolean) {
                ...
                com.uxgarage.wallpaperlibrary.activities.WallpaperBoardActivity.sRszIoAvailable = aBoolean;
                LogUtil.e("rsz.io availability: " + com.uxgarage.wallpaperlibrary.activities.WallpaperBoardActivity.sRszIoAvailable);
            }
        }.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
    }
}
