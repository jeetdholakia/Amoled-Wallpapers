package com.uxgarage.wallpaperlibrary.fragments.dialogs;
...
public class WallpaperSettingsFragment extends DialogFragment implements View.OnClickListener {
    ...
    @BindView(R.id.wallpaper_crop)
    LinearLayout mWallpaperCrop;
    @BindView(R.id.wallpaper_crop_checkbox)
    AppCompatCheckBox mWallpaperCropCheck;
    @BindView(R.id.apply_lockscreen)
    LinearLayout mApplyLockscreen;
    @BindView(R.id.apply_lockscreen_title)
    TextView mApplyLockscreenTitle;
    @BindView(R.id.apply_lockscreen_subtitle)
    TextView mApplyLockscreenSubtitle;
    @BindView(R.id.apply_lockscreen_checkbox)
    AppCompatCheckBox mApplyLockscreenCheck;
    @BindView(R.id.apply_lockscreen_error)
